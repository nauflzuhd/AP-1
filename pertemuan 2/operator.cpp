...
main() { // memulai program
    ...
    cout << (true && true) << endl; 
    cout << (true && false) << endl;      // && untuk operasi AND ( kalau dua dua benar nilainya 1 )
    cout << (false && true) << endl;
    cout << (false && false) << endl;

    cout << (true || true) << endl;
    cout << (true || false) << endl;       // || untuk operasi OR ( kalau salah satu benar nilainya 1 )
    cout << (false || true) << endl;
    cout << (false || false) << endl;

    cout << !true <<endl;       // ! untuk operasi NOT ( kebalikan )
    cout << !false <<endl;
